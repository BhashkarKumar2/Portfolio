                    ...
                    >
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 dark:text-gray-400 text-sm">Problem Solving</p>
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-gray-600 dark:text-gray-400 font-medium">Problems Solved</span>
                                <span className="text-gray-900 dark:text-white font-bold">600+</span>
                            </div>
                            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div className="bg-yellow-500 h-2 rounded-full" style={{ width: '85%' }}></div>
                            </div>
                            <p className="text-xs text-gray-500 dark:text-gray-500 mt-2">Consistent daily practice and contest participation.</p>
                        </div>
                    </a>
